...
/*void porovnej(int)
{
     ...
     //if(((phodA*60)+pminA)+5<(ohodB*60)+ominB || ((phodA*60)+pminA)+180 < (ohodB*60)+ominB) 
     if(pcasA-ocasB<1 && pcasA-ocasB>-5)
     {
      printf("neplati");
     }
}*/
...
int main(int argc, char *argv[])
{
   ...
   if(scanf("%d:%d", &ohodC, &ominC)!=2 || ohodC<0 || ohodC>23 || ominC<0 || ominC > 59)
  {
     ...
     if(pcasA>ocasB && (!pcasA>pcasB || ocasB<181))
       ...
       if((pcasA-ocasB <= -5)&&(pcasA>pcasB || pcasA-ocasB==-5 || (pcasA<181 && ocasB<181) || ((pcasA<pcasB) && (pcasA-pcasB > -181))))  /* z A na B muzu */  
       { /* vyhovuje pro minuty B (vyhovuje pro hodiny nebo pro hodiny */
